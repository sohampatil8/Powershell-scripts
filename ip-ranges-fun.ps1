# $InputFile = "C:\Users\Soham Patil\Desktop\powershell-scripts\Gopi-sir\ip-range.txt"
# $OutputFile = "C:\Users\Soham Patil\Desktop\powershell-scripts\Gopi-sir\file_ips.txt"
# $AllIPs = New-Object System.Collections.Generic.List[string]

function Get-IPsFromCIDRFile {
    param (
        [string]$InputFile,
        [string]$OutputFile
    )
